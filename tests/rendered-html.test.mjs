...
test("renders all six portfolio artifact cards", async () => {
...
test("renders the restored data challenge scenario coach artifact page", async () => {
...
test("includes the original artifact files and thumbnail", async () => {
  await Promise.all([
    ...
    access(new URL("../public/artifacts/data-challenge-scenario-coach.png", import.meta.url)),
