...
export default function TimelineArtifact() {
  return (
    <main>
      <nav className="nav artifactNav" aria-label="Artifact navigation"><a className="brand" href="/" aria-label="Portfolio home"><span>HR</span> Learning Portfolio</a><div className="navlinks"><a href="/">← All artifacts</a><a href="#timeline">Timeline</a><a href="#details">Artifact details</a></div></nav>
      ...
      <footer><div className="brand"><span>HR</span> Learning Portfolio</div><p>Artifact 01 · Timeline of AI Evolution</p><a href="/">Return to portfolio →</a></footer>
    </main>
  );
}
