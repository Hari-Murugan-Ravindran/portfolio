  ...
  return (
    <main>
      <nav className="nav artifactNav" aria-label="Artifact navigation">
        ...
        <div className="navlinks"><a href="/">← All artifacts</a><a href="#details">Artifact details</a><a href="#references">References</a></div>
      </nav>
      ...
      <section className="artifactIntro artifactPageHero" id="top">
        ...
        <div className="artifactHeading"><div><h1>From imitation<br/>to generation.</h1><p className="subtitle">A brief history of artificial intelligence and machine learning</p></div><p className="audience"><b>Designed for</b><br/>Hiring managers, colleagues, and nontechnical leaders who want a fast, meaningful orientation to the field.</p></div>
      </section>

      <section className="timeline" aria-label="AI and machine learning timeline">
        {milestones.map((item, index) => (
          <article className="milestone" key={item.year}>
            <div className="year">{item.year}</div><div className="dot" aria-hidden="true"><span>{String(index + 1).padStart(2, "0")}</span></div>
      ...
      <section className="references" id="references">
        ...
        <ol><li>Turing, A. M. (1950). Computing machinery and intelligence. <i>Mind, 59</i>(236), 433–460.</li><li>McCarthy, J., Minsky, M. L., Rochester, N., & Shannon, C. E. (1955). A proposal for the Dartmouth summer research project on artificial intelligence.</li><li>Rumelhart, D. E., Hinton, G. E., & Williams, R. J. (1986). Learning representations by back-propagating errors. <i>Nature, 323</i>, 533–536.</li><li>Krizhevsky, A., Sutskever, I., & Hinton, G. E. (2012). ImageNet classification with deep convolutional neural networks. <i>NeurIPS 25</i>.</li><li>Vaswani, A., et al. (2017). Attention is all you need. <i>NeurIPS 30</i>.</li></ol>
      </section>

      <footer><div className="brand"><span>AI</span> Learning Portfolio</div><p>Artifact 01 · AI & ML Timeline</p><a href="/">Return to portfolio →</a></footer>
    </main>
  );
}
