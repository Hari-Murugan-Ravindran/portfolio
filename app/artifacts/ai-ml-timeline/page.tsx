...
export default function TimelineArtifact() {
  ...
  return (
    <main>
      ...
      <footer><div className="brand"><span>HR</span> Hari Murugan Ravindran</div><p>Artifact 01 · Timeline of AI Evolution</p><a href={`${basePath}/`}>Return to portfolio →</a></footer>
    </main>
  );
}
